  ...
  return `
        <div class="person-card" id="${cardId}" style="position: relative;">
            ...
            <div style="text-align: left; line-height: 1.8;">
                ...
                <p style="margin: 8px 0; display: flex; align-items: center; gap: 8px;"><strong style="color: #333; display: flex; align-items: center; gap: 6px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>Inscrit le:</strong> <span style="color: #666;">${person.dateinscription ? new Date(person.dateinscription).toLocaleDateString("fr-FR") : "Non renseigné"}</span></p>
